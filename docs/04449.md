...
> 原文:[https://hackaday . com/2016/12/17/speed-test-your-toys-with-die-cast-drag-strip/](https://hackaday.com/2016/12/17/speed-test-your-toys-with-die-cast-drag-strip/)
...
Arduino 控制着一切，按钮输入、光线![race2](../Images/98ea0ad081f6c46920da501a78068d90.png)传感器输入和伺服系统。按下按钮，Arduino 将启动门拉下并启动计时器，开始比赛。当光传感器被盖住时，该车道的计时器停止计时。使用不同颜色的 4 位 7 段 LED 显示每个车道的时间。
