...
> 原文:[https://hack aday . com/2016/03/17/battery-backup-for-the-raspberry-pi/](https://hackaday.com/2016/03/17/battery-backup-for-the-raspberry-pi/)
...
![Battery](../Images/9dd78ef38ade67f3ea79ae4dcffe6379.png)[Patrick]的 Raspberry Pi UPS 不仅仅是一个连接到电源轨的电池和充电控制器；该板有一个微控制器，可以完全控制 Pi 何时唤醒、何时进入睡眠状态，并且可以使 Pi 干净关断，即使在无头模式下也是如此。全世界的 SD 卡都欢欣鼓舞。
