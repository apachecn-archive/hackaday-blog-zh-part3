...
[![](../Images/f289cad28a7882f49873e3a6f3313c37.png)](http://www.micro-examples.com/articles/index.php/File:PicoBat-circuit-schematic.png) 【布鲁诺】*是否使用了微控制器来建造他的蝙蝠探测器，但不是以我们预期的方式。PicoBat 没有使用非常高性能的 A/D 和同样庞大的微控制器，而是使用相对温和的 PIC12 和标准的超声波传感器，以及用于输出的压电蜂鸣器。加上供电轨，这就是整个电路。他运行的代码也很简单。它配置一对 GPIOs 并切换它们，没有其他逻辑。就是这样。*
