...
> 原文:[https://hack aday . com/2016/09/17/drone-flys-12-cm-on-wireless-power/](https://hackaday.com/2016/09/17/drone-flys-12-cm-on-wireless-power/)
...
[![wirelessly-powered-quadrotor-uylhy8abhiqmp4-shot0009](../Images/e9e47b98ff9de4901cf619ceb6caeec8.png)](https://hackaday.com/wp-content/uploads/2016/09/wirelessly-powered-quadrotor-uylhy8abhiqmp4-shot0009.jpg) 然而，高频电源开关对晶体管提出了真正的要求，而[Sam M]正在使用的晶体管是尖端的，专门为这种应用而设计。在高频率下，你用垃圾箱部件是走不远的。事实上，驱动线圈的整个逆变器是一种定制设计，在[Sam]的研究论文中有非常详细的描述，可在这里获得[。(PDF)](http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=7445230)
