...
> 原文:[https://hack aday . com/2015/12/28/V8-JavaScript-fixes-terribly-random-number-generator/](https://hackaday.com/2015/12/28/v8-javascript-fixes-horrible-random-number-generator/)
...
[![random_variable](../Images/736855e858f74af9110b1bb290fcc99e.png)](https://hackaday.com/wp-content/uploads/2015/12/random_variable.png) 要将随机性概念融入数学，需要一个*函数*。函数吐出数字，但数字本身不是随机的——它们是随机过程的“结果”。随机性在输入端进入函数。一位数学家说,“随机变量”是一个函数，它的值取决于世界随着时间的推移而演变的某种状态。如果在时间`t`世界的相关状态是`S[t]`，那么一个随机变量`x[t]=f(S[t])`。
...
[![histo](../Images/c0d154cd9d0dfa1b2a212fd9a8292c80.png)](https://hackaday.com/wp-content/uploads/2015/12/histo.png) 您希望 PRNG 做的最起码的事情是输出整个可能值集。如果你有一个 8 位 PRNG，你希望它能取从 0 到 255 的任何值。在此基础上，您希望每种可能的结果以相同的频率出现(对于统一的 PRNG)。最后，你希望下一次抽奖(`x[t+1]`)的结果是不可预测的，因为你已经看到了一大堆以前的抽奖。
...
[![Untitled drawing](../Images/888e13ed904ff5aadb2e1e481a8fea66.png)T2】](https://hackaday.com/wp-content/uploads/2015/12/untitled-drawing.png)
...
[![birthday-cake](../Images/20643b67d5f8f19f3dcc062304aaaef7.png)](https://hackaday.com/wp-content/uploads/2015/12/birthday-cake.jpg)
