...
> 原文:[https://hack aday . com/2015/10/18/raspberry-pi-table t-based-on-sailfish-OS/](https://hackaday.com/2015/10/18/raspberry-pi-tablet-based-on-sailfish-os/)

这个项目中有太多的漏洞，很难知道从哪里开始。所以让我们从 SailPi 平板电脑开始，这是一个树莓 Pi [在由手机电池组供电的 LCD 触摸屏上运行 Sailfish OS](https://sailfishos.org/) 。这个设计看起来更像是一个中间有 Pi 的高科技三明治，而不是平板电脑。不管它的外观如何，这才是最重要的。![COs98UBWsAAQNh5](../Images/0fdf8ccc8aca673929eeeea661d84f4b.png)创作者【阿列克西·索玛莱宁】在这个项目中花费了大量的精力将所有的碎片拼凑在一起。
