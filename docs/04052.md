...
> 原文:[https://hack aday . com/2016/11/04/the-fast-path-to-super co-badge-firmware-hacking/](https://hackaday.com/2016/11/04/the-fastest-path-to-supercon-badge-firmware-hacking/)
...
![mplabx-compile-icon](../Images/467ce9e4862418c6e845920c56d2d113.png)你从哪里得到的。十六进制文件？如果您正在使用 MPLABX，单击“清理并构建主项目”将编译您的代码，输出窗口将告诉您它的位置。例如:
...
![mplab-xpress-compile-and-download-icon](../Images/c6d3047229549dad43505ffc439f21f7.png)如果您正在使用云 IDE MPLAB Xpress，单击“制作和编程设备”按钮编译并自动下载您的。十六进制文件。
