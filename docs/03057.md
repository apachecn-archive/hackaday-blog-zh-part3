...
> 原文:[https://hack aday . com/2016/08/28/dirt-cheap-VR-gun-with-tracking-for-15-of-added-hardware/](https://hackaday.com/2016/08/28/dirt-cheap-vr-gun-with-tracking-for-15-of-added-hardware/)
...
[![ESP8266 on Fiducial](../Images/6df4f09c796560e8ec837bf4032a4215.png)](https://hackaday.com/wp-content/uploads/2016/07/esp8266-on-fiducial.png)【matthewhallberg】使用瓦楞纸板和打印输出，创造了一个带有按钮的手持桨状设备，既可以作为智能手机摄像头的控制器，也可以作为大型基准标记。手柄内部是电池和 ESP8266 微控制器。踏板上的按钮允许“前进”和“射击”触发。桨代表枪，当你四处移动它时，智能手机的摄像头会跟踪方向，因此可以独立于你的视角移动和指向枪。你可以在下面的视频中看到它的运行。
