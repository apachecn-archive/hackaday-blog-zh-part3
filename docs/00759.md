...
> 原文:[https://hack aday . com/2015/11/30/uses-for-shanni-prutchi/](https://hackaday.com/2015/11/30/uses-for-quantum-entanglement-with-shanni-prutchi/)
...
[![prutchi-entagled-photon-aparatus-path](../Images/32625d598a9faf409487b6594967a76a.png)](https://hackaday.com/wp-content/uploads/2015/11/prutchi-entagled-photon-aparatus-path.jpg) 【山尼】解释了目前识别两个纠缠光子的方法。她不仅解释了一只**如何能**进行这个实验，她还解释了她**是如何**进行这个实验的。首先，紫外激光束通过非线性光学晶体。另一边，随机偏振的纠缠光子被发射出来。这些对的偏振将永远联系在一起，测量一个对的偏振角可以指示另一个对的偏振角。接下来的问题就是识别哪些光子是链接在一起的，并利用这种纠缠来达到某种目的。
...
第一个例子是一种量子隐形传态。发送者操纵一个纠缠光子，而接收者测量它。不管两者之间有多远，操纵都是瞬间发生的。粒子本身并不移动，但本质上接收端的纠缠粒子表现出与发送端完全相同的性质。这给人一种粒子被从一个地方传送到另一个地方的感觉。[Shanni]提到它实际上是一个粒子的破坏和再造，而不是运动。
 ...
 [![prutchi-quantum-teleportation-slide-square](../Images/a33d1e99275d5127f03e57f7947738f3.png "prutchi-quantum-teleportation-slide-square")](https://hackaday.com/2015/11/30/uses-for-quantum-entanglement-with-shanni-prutchi/prutchi-quantum-teleportation-slide-square/)  [![prutchi-quantum-key-cryptography-slide-square](../Images/f3401891ecbd4657efd622168d5bc35c.png "prutchi-quantum-key-cryptography-slide-square")](https://hackaday.com/2015/11/30/uses-for-quantum-entanglement-with-shanni-prutchi/prutchi-quantum-key-cryptography-slide-square/) 
