...
> 原文:[https://hack aday . com/2015/10/01/open-source-ESC-developed-for-long board-commute/](https://hackaday.com/2015/10/01/open-source-esc-developed-for-longboard-commute/)
...
[![esc-for-longboard](../Images/ec96dca171381e1c54c45c9c65cf636e.png)](https://hackaday.com/wp-content/uploads/2015/09/esc-for-longboard.png)ESC[Ben]是围绕 STM32F4 构建的，这是一款强大的 ARM 微控制器，能够在一个小封装中进行大量计算。固件基于 [ChibiOS](http://www.chibios.org/dokuwiki/doku.php) ，还有一个 USB 端口用于连接到一个敏感的桌面绑定 UI 来调整参数。
