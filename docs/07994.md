...
> 原文:[https://hackaday . com/2017/12/26/fast-3d-printing-with-raspberry-pi-but-not-how-you-think/](https://hackaday.com/2017/12/26/fast-3d-printing-with-raspberry-pi-but-not-how-you-think/)
...
您可以通过打印一个测试方块并找到给出一个好看的角的最小数字来实验性地找到该值。例如，下面左边是一个失谐的角，右边是一个正确的角。
 ...
 [![Mistuned corner](../Images/65e484e43684165d9d524fafc9ee6d5d.png "corner-blob")](https://hackaday.com/2017/12/26/fast-3d-printing-with-raspberry-pi-but-not-how-you-think/corner-blob/) Mistuned corner [![Correctly tuned](../Images/e621e2aef9ba2bee6e7f19442b24300e.png "corner-good")](https://hackaday.com/2017/12/26/fast-3d-printing-with-raspberry-pi-but-not-how-you-think/corner-good/) Correctly tuned
