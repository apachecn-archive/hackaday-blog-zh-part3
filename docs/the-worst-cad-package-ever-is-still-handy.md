...
但是，当你需要一个快速的示意图来进行演示时，该怎么办呢？你在某个古老的会议室电脑上，你不能安装任何东西，但它仍然运行着一个能理解`<blink>`标签的浏览器？试用一下[残旧的原理图编辑器](http://www.qsl.net/wd9eyb/klunky/framed.html)。你的浏览器需要 Javascript，但仅此而已。没有 HTML 5 或任何花哨的东西。
