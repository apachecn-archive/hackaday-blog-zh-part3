...
> 原文:[https://hack aday . com/2017/06/21/you-the-only-one not-play-with-unity/](https://hackaday.com/2017/06/21/youre-the-only-one-not-playing-with-unity/)
...
设置 Unity 非常简单——只需访问网站并[下载安装程序](https://store.unity.com/download?ref=personal)。本文![](../Images/e62fdfa4ee81b51f7f7d88093fea7206.png)时间的最新版本是 5.6.1。你会想要个人版的——它大约有 5g，所以给它一些时间下载。安装完成后，前往 Oculus 网站并获取 [Unity tools 导入包](https://developer.oculus.com/downloads/package/oculus-utilities-for-unity-5/)。
...
![](../Images/67993cae9f96b69c203171dc2a0ca089.png)
