...
> 原文:[https://hack aday . com/2016/01/16/raspberry-pi-wind-measurement/](https://hackaday.com/2016/01/16/raspberry-pi-wind-measurement/)
...
![electrical_02_t](../Images/c3b53ae630aeb749519f45b59da7d4bb.png)风速计和方向传感器是使用模数子板连接到 Raspberry Pi A+的库存装置。来自温度传感器的数据是使用 I2C 获得的。在实验的一部分中，他使用 EDIMAX WiFi 适配器来收集数据。
