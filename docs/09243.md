...
> 原文:[https://hack aday . com/2018/04/22/无晶体管计数/](https://hackaday.com/2018/04/22/counting-without-transistors/)
...
[![](../Images/08749f9f996b870d9ccddf99889cbdec.png)](https://hackaday.com/wp-content/uploads/2018/04/6011651524084294976.gif) 这个建筑的灵感来自于自制计算。因此，显示总线的状态是一个反复出现的问题。当然，一排发光二极管可以工作，但是你必须数到 f，更好的解决方法是十六进制显示。这个问题的最佳解决方案是使用 num itron——基本上是七段 Nixies——并且全部使用继电器和二极管控制。
