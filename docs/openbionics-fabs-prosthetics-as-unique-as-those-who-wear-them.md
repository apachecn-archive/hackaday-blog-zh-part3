...
> 原文：<https://hackaday.com/2015/12/02/openbionics-fabs-prosthetics-as-unique-as-those-who-wear-them/>
...
![open_bionics_gesture](img/43f3a822d69dd3d746e456d48d7be739.png)如今的假肢价格不菲。为什么？这些解决方案中有许多是大量定制零件的结果，需要复杂的制造工艺，更不用说驱动这些机构所需的扭矩密集、尺寸受限的电机了。凭借昂贵的价格标签，很容易试图设计无所不包的超级手，并在此过程中，完全错过了像抓住一个水瓶一样简单的特定用例。
