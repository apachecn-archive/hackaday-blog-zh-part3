...
> 原文:[https://hackaday.com/2016/03/29/when-difference-matters/](https://hackaday.com/2016/03/29/when-difference-matters/)
...
## 单端的
 ...
 [![Single Ended: TTL, CMOS, LVTTL, Etc.](../Images/22adc139639a0645956bcce6fab6640d.png "SE1")](https://hackaday.com/2016/03/29/when-difference-matters/se1-3/) Single Ended: TTL, CMOS, LVTTL, Etc. [![Single Ended and Sources of Noise](../Images/7123967f49803a1451ef58075f4372bd.png "SE2")](https://hackaday.com/2016/03/29/when-difference-matters/se2-4/) Single Ended and Sources of Noise
...
[![diff4](../Images/d69dc23b71c7b22e2bba747f90d91b45.png)T2】](https://hackaday.com/wp-content/uploads/2016/03/diff4.png)
...
[![FPGA1](../Images/c1dddc60aec1eda2bddaedefd1b9f606.png)T2】](https://hackaday.com/wp-content/uploads/2016/03/fpga1.png)

在制作视频时，我创造了许多不同的输出给自己选择，但最终只使用了 25Mhz 的时钟版本。

接下来，我们转到零件的分配编辑器，只需选择 LVDS 作为引脚类型。通过选择一个引脚，它会自动分配一对引脚来完成差分路径。

[![FPGA2](../Images/1cf7ff4b728a17e51b3fafb63cb114e2.png)](https://hackaday.com/wp-content/uploads/2016/03/fpga2.png) 在这个 CPLD 中，实际上只有一个差分标准可供选择(LVDS 完成)。其它 CPLD/FPGA 的选择范围可能更广，可能需要使用外部电阻或其它元件，具体取决于器件和所选标准。它们还可能要求在一组引脚中或沿零件的整个一侧使用相同的标准。

## 示意图

[![FPGA3](../Images/20b0fc137a0b1a439c08ac2ea5b760fb.png)](https://hackaday.com/wp-content/uploads/2016/03/fpga3.png) 此处所示为 PCB 原理图，显示了引脚分配，插页显示了差分信号的带状电缆引脚排列。请注意 30 针带状电缆连接器上差分对之间散布的接地连接。

## LVDS

LVDS 标准是在被称为终端电阻的路径末端的电阻上产生 350mv。选择该值以最佳匹配信号路径的阻抗，对于电缆和 PCB 布局，典型值在 100-120 欧姆之间。随着速度的提高，我们越来越重视计算和控制整个路径的阻抗。

[![twisted-pair](../Images/5d45697f59c5c76efd47ea2e61381614.png)](https://hackaday.com/wp-content/uploads/2016/03/twisted-pair.png) 这里所示的工作台上的例子没有接收器，只有终端电阻。在这些速度和这种类型的应用中，最好省去示波器探头上的长接地线，这里显示的是滑入式接地夹。

[![ground](../Images/b43a99e4c861809b91d982241506e0ab.png)T2】](https://hackaday.com/wp-content/uploads/2016/03/ground.png)
...
[![scope](../Images/97199472db4c787a3cdd9bedfacd6994.png)T2】](https://hackaday.com/wp-content/uploads/2016/03/scope.png)

这里显示的是各个轨迹，然后叠加，再求差值，最终重建的波形为红色。

## 一些标准

[![specs](../Images/340015f4ab4c78722f1a065f80fe4d40.png)](https://hackaday.com/wp-content/uploads/2016/03/specs.png)

Some of the common differential standards.

[![specs2](../Images/701a358653227249ab4bdd2683dda166.png)T2】](https://hackaday.com/wp-content/uploads/2016/03/specs2.png)
...
[![AC](../Images/c94b69b736271003e105c916465e7120.png)T2】](https://hackaday.com/wp-content/uploads/2016/03/ac.png)

## 

然而，去除 DC 分量，即交流耦合信号，是有代价的。交流耦合要求信号始终处于运动状态或有规律地发生转换。

如果编码方案通过信号的跳变来表示逻辑“1 ”,通过无跳变来表示逻辑“0 ”,则交流耦合要求每隔一段时间发生一次最小的跳变，以便信号的 DC 基线不会漂移。如果没有通过串联电容耦合的交流转换驱动输入从[![8b-10b](../Images/978d0958b0fadda759f5cc98d4fe34df.png)](https://hackaday.com/wp-content/uploads/2016/03/8b-10b.png)a 高到低，电压将衰减并漂移到不可用的值。
