...
> 原文:[https://hack aday . com/2017/06/06/自驾-RC-cars-with-tensor flow-raspberry-pi-or-macbook-on board/](https://hackaday.com/2017/06/06/self-driving-rc-cars-with-tensorflow-raspberry-pi-or-macbook-onboard/)
...
[奥塔维奥]把一台 MacBook Pro 放在一辆遥控汽车上做重物，并把它叫做 car puter。计算机从电机读取霍尔效应传感器数据，以确定行驶距离(这可以用来计算速度)，并通过安装在底盘上的网络摄像头观看水流。使用 TensorFlow 将这两个源输入到神经网络中。您可以通过在整个过程中手动驾驶车辆几次来训练系统，然后让它自动驾驶。
 ...
 [![CarDiagram](../Images/30b51ea234a1fc4902832f6edd263adc.png "CarDiagram")](https://hackaday.com/2017/06/06/self-driving-rc-cars-with-tensorflow-raspberry-pi-or-macbook-onboard/cardiagram/)  [![tensorflow-rc-car](../Images/fb077dec3acebe7865c7ebe71d537632.png "tensorflow-rc-car")](https://hackaday.com/2017/06/06/self-driving-rc-cars-with-tensorflow-raspberry-pi-or-macbook-onboard/tensorflow-rc-car/) 
