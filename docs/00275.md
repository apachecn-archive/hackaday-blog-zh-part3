...
> 原文:[https://hack aday . com/2015/10/05/史上最差 cad 包依然好用/](https://hackaday.com/2015/10/05/the-worst-cad-package-ever-is-still-handy/)
...
[![klunkex](../Images/52d2b72b89df5a4c1b6d1923a5e72a48.png)](https://hackaday.com/wp-content/uploads/2015/10/klunkex.png) 真如其名，这位编辑几乎用任何定义来说都是残旧的。它是这样工作的。屏幕的上半部分成为原理图符号的调色板。下半部分有一个不可见的正方形网格，与符号大小相同(37×37)。单击一个符号，然后单击下方将该符号放置在网格中。您可以不断添加更多相同的符号，直到您选择另一个符号。你可以看到一个简单的示意图创建残次品的权利。
