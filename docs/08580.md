...
> 原文:[https://hack aday . com/2018/02/15/building-an-arduino-smart-IC-tester-for-25/](https://hackaday.com/2018/02/15/building-an-arduino-smart-ic-tester-for-25/)
...
[![](../Images/eed6940ba8faf401757a700e579a5e2f.png)](https://hackaday.com/wp-content/uploads/2018/02/ictest_detail.jpg) 【阿克谢·巴韦贾】显然是第二组的成员。他最近出版了一本关于[建造一个非常精巧的智能集成电路测试器](http://www.instructables.com/id/Smart-IC-Tester/)的指南，总成本不到 25 美元。无论你是试图识别一个未知的芯片，还是在将你的最新部件安装到你的成品中之前，从中国的慢船上验证它们是否真的工作，这个 25 美元的工具最终可以为你节省大量的时间和麻烦。
