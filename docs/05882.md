...
> 原文:[https://hack aday . com/2017/05/08/conflict-escapes-between-brilliant-rat-and-555-timer/](https://hackaday.com/2017/05/08/conflict-escalates-between-brilliant-rat-and-555-timer/)
...
所有陷阱机制都基于一个 555 单稳态螺线管触发电路 [![](../Images/eebf43eabc3142d28bf2dfd46386e6b3.png)](http://learn.digilentinc.com/Documents/324) ，该电路确保向螺线管发送足够持续时间的脉冲以正确触发陷阱。这样，即使是间歇性接触也会触发陷阱，而不仅仅是导致螺线管在没有完全启动的情况下抽动。这与使用 555 定时器对开关进行[去抖的技术相同。](http://learn.digilentinc.com/Documents/324)
