...
[![](../Images/9ec6586aef4f884c64d1b4faaf9325c9.png)](https://hackaday.com/wp-content/uploads/2017/05/dscf9480.jpg) 棋盘设计基本完善。它的灵感来自 Adafruit 的[羽毛系列](https://www.adafruit.com/feather)。模仿是最真诚的奉承。它有 4 个 MiB 闪存，一个 USB 串行适配器(cp210x)，以及一个 LiPo 电池充电器和连接器。所有相关的引脚都已断开并贴好标签，尤其是在底部。它有一个漂亮的中央复位按钮，甚至还有一个用户 LED 灯，让你尽情闪烁。
