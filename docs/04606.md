...
> 原文:[https://hack aday . com/2017/01/02/atari-now-runs-Java-thankly-dont-require-constant-updates/](https://hackaday.com/2017/01/02/atari-now-runs-java-thankfully-doesnt-require-constant-updates/)
